...
s1=subplot("Position",[0.075 0.58 0.87 0.4]);
...
set(gca,'LineWidth',2,'Tickdir','out','XTick',[0:750:10^4],'Fontsize',16)
...
set(gca,'LineWidth',2,'Tickdir','out','XTick',[0:50:400],'Fontsize',16)
xlabel(['Annual measles cases (2024)'],'FontSize',18)
ylabel('Probability density','FontSize',18)

text(-0.125,1,'B','FontSize',34,'Units','normalized');
...
ylabel('Probability density','FontSize',18)
text(-0.125,1,'C','FontSize',34,'Units','normalized');
