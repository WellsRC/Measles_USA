...
for National_Annual_Reduction=0.0025:0.0025:0.01
    [pd_1_cases,pd_1_hospital,pd_1_cost,pd_1_cost_per_case,pd_1_pro_loss,pd_1_med_cost,pd_1_med_cost_uninsured,pd_1_med_cost_public,pd_1_med_cost_private,~,~,pd_1_outbreak_response_cost,~,pd_1_deaths,prop_1_outbreak_response_cost,prop_1_pro_loss,prop_1_med_cost,prop_1_med_cost_uninsured,prop_1_med_cost_public,prop_1_med_cost_private]=National_Outcome_Distribution(National_Annual_Reduction,'Baseline',1);
    [pd_2_cases,pd_2_hospital,pd_2_cost,pd_2_cost_per_case,pd_2_pro_loss,pd_2_med_cost,pd_2_med_cost_uninsured,pd_2_med_cost_public,pd_2_med_cost_private,~,~,pd_2_outbreak_response_cost,~,pd_2_deaths,prop_2_outbreak_response_cost,prop_2_pro_loss,prop_2_med_cost,prop_2_med_cost_uninsured,prop_2_med_cost_public,prop_2_med_cost_private]=National_Outcome_Distribution(National_Annual_Reduction,'Baseline',2);
    [pd_3_cases,pd_3_hospital,pd_3_cost,pd_3_cost_per_case,pd_3_pro_loss,pd_3_med_cost,pd_3_med_cost_uninsured,pd_3_med_cost_public,pd_3_med_cost_private,~,~,pd_3_outbreak_response_cost,~,pd_3_deaths,prop_3_outbreak_response_cost,prop_3_pro_loss,prop_3_med_cost,prop_3_med_cost_uninsured,prop_3_med_cost_public,prop_3_med_cost_private]=National_Outcome_Distribution(National_Annual_Reduction,'Baseline',3);
    [pd_4_cases,pd_4_hospital,pd_4_cost,pd_4_cost_per_case,pd_4_pro_loss,pd_4_med_cost,pd_4_med_cost_uninsured,pd_4_med_cost_public,pd_4_med_cost_private,~,~,pd_4_outbreak_response_cost,~,pd_4_deaths,prop_4_outbreak_response_cost,prop_4_pro_loss,prop_4_med_cost,prop_4_med_cost_uninsured,prop_4_med_cost_public,prop_4_med_cost_private]=National_Outcome_Distribution(National_Annual_Reduction,'Baseline',4);
    [pd_5_cases,pd_5_hospital,pd_5_cost,pd_5_cost_per_case,pd_5_pro_loss,pd_5_med_cost,pd_5_med_cost_uninsured,pd_5_med_cost_public,pd_5_med_cost_private,~,~,pd_5_outbreak_response_cost,~,pd_5_deaths,prop_5_outbreak_response_cost,prop_5_pro_loss,prop_5_med_cost,prop_5_med_cost_uninsured,prop_5_med_cost_public,prop_5_med_cost_private]=National_Outcome_Distribution(National_Annual_Reduction,'Baseline',5);
    ...
    Prop_Outbreak_Response=cell(length(Year),1);
    Prop_Direct_Medical=cell(length(Year),1);
    Prop_Direct_Medical_Uninsured=cell(length(Year),1);
    Prop_Direct_Medical_Public=cell(length(Year),1);
    Prop_Direct_Medical_Private=cell(length(Year),1);
    Prop_Productivity_Loss=cell(length(Year),1);
    ...
    % Outbreak_repsponse (Proportion)

    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_1_outbreak_response_cost,0.5);    
    Prop_Outbreak_Response{1} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_2_outbreak_response_cost,0.5); 
    Prop_Outbreak_Response{2} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_3_outbreak_response_cost,0.5); 
    Prop_Outbreak_Response{3} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_4_outbreak_response_cost,0.5); 
    Prop_Outbreak_Response{4} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_5_outbreak_response_cost,0.5); 
    Prop_Outbreak_Response{5} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    ...
    % Direct Medical (Proportion)
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_1_med_cost,0.5);    
    Prop_Direct_Medical{1} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_2_med_cost,0.5); 
    Prop_Direct_Medical{2} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_3_med_cost,0.5); 
    Prop_Direct_Medical{3} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_4_med_cost,0.5); 
    Prop_Direct_Medical{4} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_5_med_cost,0.5); 
    Prop_Direct_Medical{5} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    ...
    % Direct Medical: Uninsured (Proportion)

     [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_1_med_cost_uninsured,0.5);    
    Prop_Direct_Medical_Uninsured{1} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_2_med_cost_uninsured,0.5); 
    Prop_Direct_Medical_Uninsured{2} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_3_med_cost_uninsured,0.5); 
    Prop_Direct_Medical_Uninsured{3} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_4_med_cost_uninsured,0.5); 
    Prop_Direct_Medical_Uninsured{4} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_5_med_cost_uninsured,0.5); 
    Prop_Direct_Medical_Uninsured{5} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    ...
    % Direct Medical: Public (Proportion)

     [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_1_med_cost_public,0.5);    
    Prop_Direct_Medical_Public{1} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_2_med_cost_public,0.5); 
    Prop_Direct_Medical_Public{2} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_3_med_cost_public,0.5); 
    Prop_Direct_Medical_Public{3} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_4_med_cost_public,0.5); 
    Prop_Direct_Medical_Public{4} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_5_med_cost_public,0.5); 
    Prop_Direct_Medical_Public{5} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    ...
    % Direct Medical: Private (Proportion)

     [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_1_med_cost_private,0.5);    
    Prop_Direct_Medical_Private{1} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_2_med_cost_private,0.5); 
    Prop_Direct_Medical_Private{2} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_3_med_cost_private,0.5); 
    Prop_Direct_Medical_Private{3} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_4_med_cost_private,0.5); 
    Prop_Direct_Medical_Private{4} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_5_med_cost_private,0.5); 
    Prop_Direct_Medical_Private{5} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    ...
    % Productivity loss (proportion)

    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_1_pro_loss,0.5);    
    Prop_Productivity_Loss{1} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_2_pro_loss,0.5); 
    Prop_Productivity_Loss{2} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_3_pro_loss,0.5); 
    Prop_Productivity_Loss{3} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_4_pro_loss,0.5); 
    Prop_Productivity_Loss{4} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    
    [mle,lb_hdi,ub_hdi]=Estimate_HDI(prop_5_pro_loss,0.5); 
    Prop_Productivity_Loss{5} = [num2str(mle,'%4.2f') '% (' num2str(lb_hdi,'%4.2f')  '%' char(8211) num2str(ub_hdi,'%4.2f') '%)'];
    ...
    Output_Table{count}=table(Year,Cases,Hospitalizations,Deaths, Cost,Outbreak_Response,Prop_Outbreak_Response,Productivity_Loss,Prop_Productivity_Loss,Direct_Medical,Prop_Direct_Medical,Direct_Medical_Uninsured,Prop_Direct_Medical_Uninsured,Direct_Medical_Public,Prop_Direct_Medical_Public,Direct_Medical_Private,Prop_Direct_Medical_Private,Cost_per_Case);
