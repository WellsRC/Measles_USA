function [Estimated_Vaccination_Coverage] = Vaccination_Coverage_Adjusted(x,beta_x,beta_insurance,q_insurance,dZ_County)
...
z=beta_insurance.Private+x*beta_x+dZ_County;
