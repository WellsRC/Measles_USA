function [Estimated_Vaccination_Coverage] = Vaccination_Coverage(x,beta_x,beta_insurance,q_insurance)

% Uninsured population
z=beta_insurance.Uninsured+x*beta_x;
...
z=beta_insurance.Public+x*beta_x;
