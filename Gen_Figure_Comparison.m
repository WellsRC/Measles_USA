...
if(measure_increase)
    ...
    Measure_Diff=Measure_Baseline-Measure_Reduction;
end
...
Measure_Diff(Measure_Diff<x_diff(1))=x_diff(1);
Measure_Diff(Measure_Diff>x_diff(end))=x_diff(end);
