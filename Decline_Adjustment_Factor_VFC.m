function [County_Info,dZ_Reduction]=Decline_Adjustment_Factor_VFC(Vaccine,Model_Num,dZ_County,National_Reduction,Age_Reduction)
Year=2023;
% Load the data
...
if(Age_Reduction(3))
    [Estimated_Vaccination_Coverage] = Vaccination_Coverage_Adjusted_VFC([County_Data_model_10_to_14.X County_Data_model_10_to_14.XI County_Data_model_10_to_14.X2],beta_x,beta_insurance,County_Data_model_10_to_14,dZ_County(:,3)+dZ_Reduction);
    County_Info.Vaccine_Uptake_10_to_14=Estimated_Vaccination_Coverage.Overall;
end

if(Age_Reduction(4))
    [Estimated_Vaccination_Coverage] = Vaccination_Coverage_Adjusted_VFC([County_Data_model_15_to_19.X County_Data_model_15_to_19.XI County_Data_model_15_to_19.X2],beta_x,beta_insurance,County_Data_model_15_to_19,dZ_County(:,4)+dZ_Reduction);
    County_Info.Vaccine_Uptake_15_to_19=Estimated_Vaccination_Coverage.Overall;
end

if(Age_Reduction(5))
    [Estimated_Vaccination_Coverage] = Vaccination_Coverage_Adjusted_VFC([County_Data_model_20_to_24.X County_Data_model_20_to_24.XI County_Data_model_20_to_24.X2],beta_x,beta_insurance,County_Data_model_20_to_24,dZ_County(:,5)+dZ_Reduction);
