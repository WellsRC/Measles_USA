function National_Reduction_Vaccine_Uptake_Altered_Transmission(National_Reduction,Age_Reduction,Age_0_6,Extent_Control)
if(~Age_0_6)
...
clearvars -except Model_Num Vaccine National_Reduction Age_Reduction Age_0_6 Extent_Control
...
load('Baseline_Estimate_Measles_Incidence.mat','beta_seed');
beta_j=beta_seed.*(1-Extent_Control); % Reducing it based on the extent of control
...
if(~Age_0_6)
    save(['National_Reduction=' num2str(100*National_Reduction) '_' FN_Age_Class{:} '_Extent_Control=' num2str(100.*Extent_Control) '.mat'],'County_Data_Vaccine_Reduction','Proportion_Size_Age_Unvaccinated','Proportion_Size_Age_Vaccinated')
else
    save(['National_Reduction=' num2str(100*National_Reduction) '_Ages_0_to_6_Extent_Control=' num2str(100.*Extent_Control) '.mat'],'County_Data_Vaccine_Reduction','Proportion_Size_Age_Unvaccinated','Proportion_Size_Age_Vaccinated')
end
